...
class AssignmentTests(unittest.TestCase):
    ...
    def test_find_markers_simple_rectangle(self):
        ...
        file_names = ['simple_rectangle.png', 'simple_rectangle_noisy.png', 'simple_rectangle_noisy_gaussian.png']
    ...
    def test_find_markers_wall_image(self):
        ...
        #file_names = ['rectangle_wall_noisy_gaussian.png']
        file_names = ['rectangle_wall.png', 'rectangle_wall_noisy.png','rectangle_wall_noisy_gaussian.png']
    ...
    def test_solving_for_homography(self):
        ...
        print(cv2_warped_corners)
        print("my answer: ")
        print(student_warped_corners)
